            ...
            const g = u.I.extend({
                ...
                submitAnswer() {
                    ...
                    if (0 === t.length) {
                        ...
                        return t.html("Du musst etwas eingeben!"), t.removeClass("alert-info"), t.addClass("alert-danger"), t.show(), this.alertTimeout && clearTimeout(this.alertTimeout), this.alertTimeout = setTimeout((() => {
