(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    ["games/wordspud"], {
        ...
        50977: (t, e, n) => {
            ...
            const l = r.I.extend({
                template: s().template('<link href="https://fonts.googleapis.com/css?family=Merriweather+Sans&display=swap" rel="stylesheet"> <div id="page-wordspud" class="page gray"> <div id="player"> <h1><%=username%></h1> </div> <div id="game" class="game pt-pageholder"> <div class="pt-page-off wordspud-page state-waiting"> <div class="container gameplay"> <h3>Warte auf Spieler</h3> </div> </div> <div class="pt-page-off wordspud-page state-startbutton"> <div class="container gameplay"> <h3>Hier drücken wenn alle bereit sind</h3> <form class="pure-form"> <button type="submit" id="button-start-game" class="button-wordspud button-xlarge pure-button pure-input-1">ALLE BEREIT</button> </form> </div> </div> <div class="pt-page-off wordspud-page state-writing"> <div class="container gameplay"> <h2 id="wordspud-writing-root"></h2> <p>Du bist dran!</p> <form class="pure-form"> <div class="pure-u-1"> <input id="wordspud-input" name="spud" class="pure-input-1 spud jbg-input" type="text" placeholder="Gib etwas ein" autocapitalize="off" autocorrect="off" autocomplete="off" maxlength="32"> </div> <div class="pure-u-1-2 right"> <div class="wordspud-submit"><button type="submit" id="wordspud-submit" class="button-wordspud pure-button button-large pure-input-1"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;Senden</button></div> </div> </form> </div> </div> <div class="pt-page-off wordspud-page state-vote"> <h2 id="wordspud-vote-spud"></h2> <div class="container gameplay"> <h3>Gefällt es dir?</h3> <form class="pure-form"> <div class="wordspud-vote-yes" data-vote="1"><button id="wordspud-vote-yes" data-vote="1" class="button-wordspud-yes button-xlarge pure-button pure-input-1"><i class="fas fa-check"></i>&nbsp;&nbsp;JA</button></div> <div class="wordspud-vote-no" data-vote="-1"><button id="wordspud-vote-no" class="button-wordspud-no button-xlarge pure-button pure-input-1"><i class="fas fa-times"></i>&nbsp;&nbsp;NEIN</button></div> </form> </div> </div> <div class="pt-page-off wordspud-page state-vote-wait"> <div class="container gameplay"> <h2 id="wordspud-vote-wait-spud"></h2> <h3>Du wirst beurteilt.</h3> </div> </div> <div class="pt-page-off wordspud-page state-nothing"> <div class="container gameplay"> <h2 id="wordspud-nothing-root"></h2> <p>Gib deinen Beitrag ab</p> <form class="pure-form"> <div class="pure-u-1"> <input id="wordspud-comment" name="comment" class="pure-input-1 comment jbg-input" type="text" placeholder="Schreib etwas" autocapitalize="off" autocorrect="off" autocomplete="off" maxlength="50"> </div> <div class="pure-u-1-2 right"> <div class="wordspud-comment-submit"><button type="submit" id="wordspud-comment-submit" class="button-wordspud pure-button button-large pure-input-1"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;Senden</button></div> </div> </form> </div> </div> <div class="pt-page-off wordspud-page state-voted"> <div class="container gameplay"> <h2 id="wordspud-voted-spud"></h2> <p>Warte auf Spieler</p> </div> </div> <div class="pt-page-off wordspud-page state-gameover"> <div class="container gameplay"> <form class="pure-form"> <button type="button" id="wordspud-keep-playing" data-vote="1" class="button-wordspud button-xlarge pure-button pure-input-1">Nächste Runde</button> <button type="button" id="wordspud-new-game" data-vote="-1" class="button-wordspud button-xlarge pure-button pure-input-1">Neues Spiel</button> </form> </div> </div> </div> </div> '),
                lacksAudience: !0,
                typeInterval: null,
                lastSpud: "",
                currentSpud: "",
