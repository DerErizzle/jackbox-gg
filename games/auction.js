(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    ["games/auction"], {
        ...
        41571: (t, e, n) => {
            ...
            const g = '<div id="page-auction" class="page"> <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Rokkitt"> <div id="auction-preload" class="auction-preload"></div> <div id="game" class="game pt-pageholder"> <div id="state-lobby" class="pt-page-off pushed-down-page auction-page"> <div class="container"> <br/><span id="auction-lobby-text" class="big-text"></span><br/> <form class="pure-form"> <button type="button" id="auction-startgame" class="button-auction button-xlarge pure-button pure-input-1">ALLE BEREIT</button> <button type="button" id="auction-stopcountdown" class="button-auction button-xlarge pure-button pure-input-1">ABBRECHEN</button> </form> </div> </div> <div id="state-logo" class="pt-page-off pushed-down-page auction-page"> <div class="logo-image" style="width:100%"> <img class="pure-img" style="margin-left:auto;margin-right:auto" src="' + p()(h) + '"> </div> </div> <div id="state-draw" class="pt-page-off pushed-down-page auction-page"> <span id="title" class="big-text">Bitte zeichne:</span><br/> <canvas id="auction-sketchpad" class="sketchpad" width="240" height="300" style="background-color:#fff"> Sorry, your browser is not supported. </canvas> <form class="pure-form container"> <button type="submit" id="auction-submitdrawing" class="submit-drawing button-auction button-large pure-button pure-input-1" style="margin-top:0"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;senden</button> <div id="auction-submitdrawing-loading" style="display:none" class="button-auction-loading"></div> </form> </div> <div id="state-done-drawing" class="pt-page-off pushed-down-page auction-page"> <br/><span class="big-text">Danke für die Zeichnungen!</span><br/> </div> <div id="state-auction" class="pt-page-off auction-page"> <div id="available-cash"><h1 id="auction-money">$XXXXX</h1></div> <div id="auction-info"><div class="auction-centered-content" id="auction-centered-info"></div></div> <div id="auction-skip-content"><button type="button" id="auction-skip-button" class="button-auction button-large pure-button pure-input-1">Überspringen</button></div> <div id="auction-bid-buttons"></div> <div id="auction-screw-content"></div> <div id="auction-cashgrab-content"></div> <div id="auction-bank-content"></div> <div id="auction-message"><div class="auction-centered-content" id="auction-centered-message"></div></div> </div> <div id="state-post-game" class="pt-page-off pushed-down-page auction-page"> <div class="container"> <br/><span id="auction-post-game-text" class="big-text"></span><br/> <form class="pure-form"> <button type="button" id="auction-sameplayers" class="button-auction button-xlarge pure-button pure-input-1 auction-endbuttons">GLEICHE SPIELER</button> <button type="button" id="auction-newplayers" class="button-auction button-xlarge pure-button pure-input-1 auction-endbuttons">ANDERE SPIELER</button> </form> </div> </div> </div> </div> ';
