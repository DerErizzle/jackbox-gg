            ...
            const d = l.I.extend({
                ...
                updatePlayer() {
                    ...
                    if (i && "Lobby" === i) {
                        ...
                        if ("Lobby_ChooseCharacter" === o) {
                            this.hideCharacterLobbyButtons(), s()("#pollposition-choosecharacter-text").html("Wähle deinen Agenten");
                            let o = "";
                            ...
                            return s()("#pollposition-choosecharacter").html(o), this.showScreen(".state-choosecharacter"), t.isAllowedToStartGame && ("CanStart" === i ? (s()("#pollposition-characterlobby-text").html("Drücke diesen Knopf, wenn alle beigetreten sind"), s()("#pollposition-character-startgame").show()) : "Countdown" === i && (s()("#pollposition-characterlobby-text").html("Drücke den Knopf um den Spielstart abzubrechen"), s()("#pollposition-character-stopcountdown").show())), void this.onResize()
                        }
                        if ("PostGame" === i) {
                            t.isAllowedToStartGame ? (s()("#pollposition-post-lobby-text").html("Was möchtet ihr machen?"), s()(".pollposition-endbuttons").show()) : s()("#pollposition-post-lobby-text").html("Lehne dich zurück und entspanne!");
                        ...
                        if (!t.isAllowedToStartGame) return s()("#pollposition-lobby-text").html("Lehne dich zurück und entspanne!"), void this.showScreen(".state-lobby");
                        "WaitingForMore" === i ? s()("#pollposition-lobby-text").html("waiting for all players to join") : "CanStart" === i ? (s()("#pollposition-lobby-text").html("Drücke diesen Knopf, wenn alle beigetreten sind"), s()("#pollposition-startgame").show()) : "Countdown" === i && (s()("#pollposition-lobby-text").html("Drücke den Knopf um den Spielstart abzubrechen"), s()("#pollposition-stopcountdown").show()), this.showScreen(".state-lobby")
                    ...
                    }), this.percentageDelayTime), this.showScreen(".state-enterpercentage"), this.currentRange.resize()) : "Gameplay_WaitForPercentage" === o ? (".state-waitforpercentage" !== this.activeScreen && (s()(".state-waitforpercentage .question-text").html(e.question), s()("#waitingforpercentage-text").html(`Warte, bis ${e.player} einen Prozentwert eingegeben hat.`)), this.showScreen(".state-waitforpercentage")) : "Gameplay_WaitForAllPercentages" === o ? this.showScreen(".state-waitforallpercentages") : "Gameplay_WaitForAudience" === o ? this.showScreen(".state-waitforaudience") : this.showLogo();
                        ...
                        if ("Gameplay_WaitForChooseUpOrDown" === o) this.showScreen(".state-waitforupordown");
                            ...
                            s()(".state-chooseupordown .survey-text").html(e.survey), s()(".question-text").html(e.question), s()("#chooseupordown-text").html("Denkst du, die richtige Antwort ist:");
                            let t = "";
                            for (n = 0; n < e.choices.length; n++) t += `<button type='button' data-choice='${e.choices[n].id.toString()}' class='pollposition-button pollposition-high-low-button pollposition-choice-button'><span>${e.choices[n].id.toString().replace("Much_Higher","Viel mehr").replace("Much_Lower","Viel weniger").replace("Higher","Mehr").replace("Lower","Weniger").replace("_"," ")}</span></button>`;
                ...
                updateAudience() {
                    ...
                    if ("Gameplay_EnterPercentage" === e) {
                        ...
                        e += "<button type='button' data-choice='-1' class='pollposition-button pollposition-choice-button'><span>Das trifft nicht auf mich zu</span></button>", s()("#pollposition-audiencechooseoption").html(e), this.showScreen(".state-audience-chose-option")
                    ...
                    } else s()(".state-audience-wait .audience-wait-text").html("Du bist im Publikum! Warte, bis du antworten kannst."), s()(".state-audience-wait .audience-usage-text").html("Die Stimme vom Publikum wird genutzt, wenn 5 oder mehr Leute antworten."), this.showScreen(".state-audience-wait")
                },
                hideLobbyButtons() {
                ...
                submitChoice(t) {
                    ...
                    return s()(".pollposition-choice-button").attr("disabled", !0), p.app.client.isRole("player") ? p.app.client.send("SendMessageToRoomOwner", {
                        ...
                        type: "vote",
                        vote: e
                    }), s()("#pollposition-audiencechooseoption").html(""), s()(".state-audience-wait .audience-wait-text").html("Danke, Person im Publikum!"), s()(".state-audience-wait .audience-usage-text").html("Audience answers are used when 5 or more audience members answer the question."), this.showScreen(".state-audience-wait")), !1
                },
                submitCategory(t) {
