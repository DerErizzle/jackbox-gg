                    ...
                    return w((function*() {
                        ...
                        if (t.currentAnswerQuestionId = -1, "RoomFull" !== o) {
                            if ("GameLocked" === o) c.b.show(Error("Game is in progress. Please wait for a new game to start."), {
                                ...
                                "WaitingForMore" === s ? t.$el.find("#earwax-lobby-text").html("Warte auf weitere Spieler") : "CanStart" === s ? (t.$el.find("#earwax-lobby-text").html("Warte auf mehr Spieler"), t.$el.find("#earwax-startgame").show()) : "Countdown" === s ? (t.$el.find("#earwax-lobby-text").html("Drücke um den Spielstart abzubrechen"), t.$el.find("#earwax-stopcountdown").show()) : "PostGame" === s && (t.$el.find("#earwax-lobby-text").html("Was möchtet ihr nun machen?"), i()(".earwax-endbuttons").show()), t.showScreen("#state-lobby")
                                ...
                                } else t.$el.find("#notchoosing").html(`${e.choosingPlayerName} wählt ein Thema`), t.showScreen(".state-notchoosing");
                                ...
                                if (a.isSelecting) {
                                    ...
                                    o ? t.$el.find("#selectingsound").html(`Wähle das erste Geräusch für:<br>${e.prompt}`) : t.$el.find("#selectingsound").html(`Wähle das zweite Geräusch für:<br>${e.prompt}`), i()(".button-fieldset").html(s), t.showScreen("#state-selectingsound"), t.clickEnabled = !0
                                } else t.$el.find("#notselectingsound").html("Warte auf die anderen Spieler"), t.showScreen("#state-notselectingsound");
                            else if ("Gameplay_SoundSelection" === n && "Gameplay_SoundSelected" === o) t.$el.find("#notselectingsound").html("Warte, bis die anderen Spieler ihre Geräusche gewählt haben"), t.showScreen("#state-notselectingsound");
                                ...
                                let s = "";
                                if (a.isChoosing) {
                                    t.$el.find("#vote-text").html("WÄHLE EINEN GEWINNER");
                                    const a = e.choices || [];
                                    ...
                                    t.$el.find("#vote-text").html("WÄHLE FÜR DEN BESTEN");
                                    const i = e.choices || [];
